...
if (isset($_POST["userSubmit"])) {
	...
	if ($resultCount > 0) {
		header("Location: userNew.php?error=existujiciUcet&userLogin=" . $userLogin . '&userEmail=' . $userEmail);
		exit();
	}
	...
	if ($stmt->execute()) {
		header("Location: userVypis.php?odeslano=zapsano");
		$stmt->close();
		$conn->close();
		exit;
	} else {
						...
						<div class="container-xl">
							...
							<div class="row g-4 settings-section">
								...
								<div class="col-12 col-md-4">
									<h3 class="section-title">Práva a povinnosti</h3>
								...
								<div class="col-12 col-md-8">
									<div class="app-card app-card-settings shadow-sm p-4">
										...
										<div class="app-card-body">
											<form action="userNew.php" method="post" class="form-signup">
												...
												if (isset($_GET["error"])) {
													...
													if ($_GET["error"] == "invalidLogin") {
														echo '<p class="badge bg-danger">Uživatelské jméno obsahovalo zakázané znaky</p>';
													}
