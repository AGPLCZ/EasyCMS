    ...
    <div class="container px-4 mt-4 my-3 py-0" id="hanging-icons">
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            ...
            <div class="col d-flex align-items-start">
                ...
                <div>
                    <h2>Vícedenní výlety</h2>
                    <p>Když jedeme na vícedenní výlet, jedna noc nás přijde na 500 Kč, v ceně jsou zahrnuté náklady za dopravu, ubytování, jídlo, i profesionální průvodcovské služby.</p>
    ...
    <main>
        <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3  text-white bg-primary border-primary">
                        <h4 class="my-0 fw-normal text-uppercase">profesionální průvodce</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            ...
                            <li> 2 týdny / 12 000 Kč</li>
                            <li> 3 týdny / 18 000 Kč</li>
                            <li> 4 týdny / 24 000 Kč</li>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3  text-white bg-primary border-primary">
                        <h4 class="my-0 fw-normal text-uppercase">výlet pro skupinu</h4>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title pricing-card-title"><small class="text-muted fw-light">den / 1 osoba / </small>400 Kč</h3>
                        <ul class="list-unstyled mt-3 mb-4">
                            <li><b>V ceně</b></li>
                            <li>profesionální průvodce</li>
                            <li>jídlo a patí</li>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3  text-white bg-primary border-primary">
                        <h4 class="my-0 fw-normal text-uppercase">letní tábor</h4>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title pricing-card-title"><small class="text-muted fw-light">1. týden / 1 osoba / </small>2 400 Kč</h3>
                        <ul class="list-unstyled mt-3 mb-4">
                            <li><b>V ceně</b></li>
                            <li>profesionální průvodce</li>
                            <li>jídlo a patí</li>
    ...
    <main>
        ...
        <div class="table-responsive">
            <table class="table text-start">
                <tbody>
                    <tr>
                        <th style="width: 30%;">Služby</th>
                        <th style="width: 40%;">Započitáno v ceně</th>
                    ...
                    <tr>
                        <th scope="row" class="text-start">
                            <p class="card-title pricing-card-title"><small class="fw-light">Zajistíme spolu-účastníky
                        </th></small></p>
                        <th scope="row" class="text-start">
                            <p class="card-title pricing-card-title"><small class="fw-light">4 děti do Vaší skupiny</small></p>
                        </th>
                        <th>
...
<div class="bg-light">
    ...
    <div class="container px-4 mt-4 py-0">
